...
- 🟣 **[nshcr/DockAutoHide](https://github.com/nshcr/DockAutoHide)** · [#4](https://github.com/nshcr/DockAutoHide/pull/4) ci: add immutable release validation and asset verification · *2 days ago*
- 🟣 **[nshcr/DockAutoHide](https://github.com/nshcr/DockAutoHide)** · [#3](https://github.com/nshcr/DockAutoHide/pull/3) ci: restrict release uploads and add homebrew tap automation · *2 days ago*
- 🟣 **[nshcr/DockAutoHide](https://github.com/nshcr/DockAutoHide)** · [#2](https://github.com/nshcr/DockAutoHide/pull/2) refactor: improve dock frame fallback logic · *3 days ago*
- 🟣 **[nshcr/DockAutoHide](https://github.com/nshcr/DockAutoHide)** · [#1](https://github.com/nshcr/DockAutoHide/pull/1) feat: restore manual dock auto-hide on app quit · *3 days ago*
...
quadrantChart
    ...
    DockAutoHide: [0.050, 0.130]
    obsidian-linter: [0.050, 0.050]
    pnpm: [0.141, 0.050]
    chrome-redirect-skipper: [0.188, 0.140]
    InputSourcePro: [0.112, 0.217]
    build-extra: [0.232, 0.050]
    ollama-js: [0.298, 0.113]
    obsidian-minimal: [0.235, 0.229]
    mihon: [0.050, 0.292]
    tauri: [0.351, 0.050]
    vitepress: [0.377, 0.153]
    alt-tab-macos: [0.178, 0.333]
    orbstack: [0.267, 0.321]
...
| **3** | [nshcr/DockAutoHide](https://github.com/nshcr/DockAutoHide) | 4 | 0 | **4** |
...
|----------|--------|------:|----------:|
| **Overview** | **Total Contributions** | **81** | **100%** |
| | Active Repositories | 15 | - |
| | Core Projects (Member/Collab) | 1 | - |
| **Authored** | **Issues Created** | **13** | **16.0%** |
| | 🟢 Open Issues | 8 | 9.9% |
| | ⚫ Closed Issues | 5 | 6.2% |
| | **Pull Requests Created** | **46** | **56.8%** |
| | 🟣 Merged PRs | 37 | 45.7% |
| | 🟢 Open PRs | 1 | 1.2% |
| | 🔴 Closed PRs | 8 | 9.9% |
| **Participated** | **Comments & Discussions** | **21** | **25.9%** |
| | **Code Reviews** | **1** | **1.2%** |
| | **Assigned Issues** | **0** | **0.0%** |

</details>

<sub>Last updated: 2026-03-26 00:08:53 UTC</sub>
